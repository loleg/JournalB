...
function scaleCommunity()
{
	...
	/*var community_count = $(".sidebar .content").children().length - 1;
	var pos1 = Math.floor((Math.random()*community_count)+1);
	var pos2 = Math.floor((Math.random()*community_count)+1);
		
	$(".community-ads .adbox:nth-child(1)").insertAfter($(".sidebar .content .row:nth-child("+pos1+")")[0]);
	$(".community-ads .adbox:nth-child(2)").insertAfter($(".sidebar .content div:nth-child("+pos2+")")[0]);*/
}
